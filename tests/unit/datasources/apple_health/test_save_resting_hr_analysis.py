...
from training_readiness.etl.process_data.apple_health.process_resting_hr_data import save_resting_hr_analysis
...
class TestSaveRestingHrAnalysis:
    ...
    def test_save_single_record(self):
        ...
        test_data = [{
            'Resting_HR_Date': '01/01/2024',
            'Resting_HR_Value': 65.0
        }]
    ...
    def test_save_multiple_records(self):
        ...
        test_data = [
            ...
            {
                'Resting_HR_Date': '01/02/2024',
                'Resting_HR_Value': 68.0
            },
            {
                'Resting_HR_Date': '01/03/2024',
                'Resting_HR_Value': 62.0
            }
        ]
