...
def save_resting_hr_analysis(output_data, output_file='resting_hr_analysis.csv'):
    ...
    print(f"Successfully saved {len(output_data)} resting heart rate records to {output_file}")
...
def main(debug=False):
    ...
    output_file = os.path.join(script_dir, f'cleaned/apple_resting_hr_analysis_{timestamp}.csv')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Process Apple Health resting heart rate data from XML export')
